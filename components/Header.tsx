...
export default function Example() {
  ...
  return (
    <header className="sticky top-0 z-50 px-3">
      <nav aria-label="Global" className="mx-auto mt-4 flex max-w-7xl items-center justify-between rounded-full border border-slate-200/80 bg-white/85 px-5 py-3 shadow-sm shadow-slate-900/5 backdrop-blur-xl lg:px-6">
