...
const en: CommonMessages = {
  header: {
    ...
    mobileEyebrow: 'Global expert network',
    mobilePitch: 'Connect important decisions with relevant firsthand experience, supported from question to insight.',
  },
  themeToggleLabel: 'Toggle color theme',
  languageSwitcherLabel: 'Change language',
  footer: {
    logoAlt: 'Learnmark',
    description: 'A global expert network connecting enterprises with relevant operators and specialists for high-value consultation.',
    startProject: 'Discuss a project',
    ...
    closing: 'Global expertise for better business decisions.',
  },
}
...
const zhCN: CommonMessages = {
  header: {
    ...
    aboutUs: '关于我们',
    startProject: '讨论项目',
    mobileEyebrow: '全球专家网络',
    mobilePitch: '让企业重要决策连接相关一手经验，从问题到洞察全程获得专属支持。',
  },
  themeToggleLabel: '切换颜色主题',
  languageSwitcherLabel: '切换语言',
  footer: {
    logoAlt: 'Learnmark',
    description: '连接企业与全球相关经营者和专业人士，为重要决策提供高价值专家咨询。',
    startProject: '讨论项目',
    joinExperts: '加入专家网络',
    companyLabel: '公司',
...
const zhTW: CommonMessages = {
  header: {
    ...
    aboutUs: '關於我們',
    startProject: '討論專案',
    mobileEyebrow: '全球專家網絡',
    mobilePitch: '讓企業重要決策連結相關第一手經驗，從問題到洞察全程獲得專屬支援。',
  },
  themeToggleLabel: '切換色彩主題',
  languageSwitcherLabel: '切換語言',
  footer: {
    logoAlt: 'Learnmark',
    description: '連結企業與全球相關經營者和專業人士，為重要決策提供高價值專家顧問服務。',
    startProject: '討論專案',
    joinExperts: '加入專家網絡',
    companyLabel: '公司',
...
const ja: CommonMessages = {
  header: {
    ...
    aboutUs: '会社情報',
    startProject: '案件を相談',
    mobileEyebrow: 'グローバル専門家ネットワーク',
    mobilePitch: '重要な事業判断を関連する一次経験へつなぎ、問いから知見まで専任支援を提供します。',
  },
  themeToggleLabel: 'カラーテーマを切り替える',
  languageSwitcherLabel: '言語を変更する',
  footer: {
    logoAlt: 'Learnmark',
    description: '企業を世界の実務家や専門職へつなぎ、重要な判断に高度な専門家コンサルテーションを提供します。',
    startProject: '案件を相談',
...
const fr: CommonMessages = {
  header: {
    ...
    mobileEyebrow: 'Réseau mondial d’experts',
    mobilePitch: 'Reliez les décisions importantes à l’expérience de terrain, avec un accompagnement dédié de la question à l’insight.',
  },
  themeToggleLabel: 'Changer le thème de couleur',
  languageSwitcherLabel: 'Changer de langue',
  footer: {
    logoAlt: 'Learnmark',
    description: 'Un réseau mondial reliant les entreprises aux professionnels pertinents pour des consultations à forte valeur.',
    startProject: 'Discuter d’un projet',
    ...
    closing: 'L’expertise mondiale au service de meilleures décisions.',
  },
}
...
const de: CommonMessages = {
  header: {
    ...
    mobileEyebrow: 'Globales Expertennetzwerk',
    mobilePitch: 'Verbinden Sie wichtige Entscheidungen mit relevanter Praxiserfahrung, begleitet von der Frage bis zur Erkenntnis.',
  },
  themeToggleLabel: 'Farbschema wechseln',
  languageSwitcherLabel: 'Sprache ändern',
  footer: {
    logoAlt: 'Learnmark',
    description: 'Ein globales Netzwerk, das Unternehmen für hochwertige Beratung mit relevanten Praktikern und Spezialisten verbindet.',
    startProject: 'Projekt besprechen',
    ...
    closing: 'Globale Expertise für bessere Geschäftsentscheidungen.',
  },
}
