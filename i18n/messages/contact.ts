...
export const contactMessages: Record<Locale, ContactMessages> = {
  en: {
    seoTitle: 'Contact Us',
    seoDescription: 'Contact Learnmark to discuss Shopify store development, custom themes, AI consulting, cloud modernization, platform engineering, and software delivery needs.',
    seoKeywords: ['contact Learnmark', 'Shopify development contact', 'AI consulting contact', 'cloud consulting contact', 'software consulting inquiry'],
    eyebrow: 'Contact Learnmark',
    title: 'Shape your next Shopify, AI, or cloud initiative.',
    description: 'Tell us about the store, product, or platform you are building. We will help clarify the customer experience, technical path, and right next conversation.',
    focusAreas: ['Shopify stores', 'Custom themes', 'AI strategy', 'LLM integration', 'Cloud modernization', 'Platform engineering'],
    highlights: [
      { name: 'Focused discovery', description: 'We start with commerce or product goals, customer journeys, constraints, risks, and the delivery context behind the request.' },
      { name: 'Practical response', description: 'Expect a concise reply with next steps, fit, and the right path for a product or platform discussion.' },
      { name: 'Production mindset', description: 'Shopify, AI, cloud, and delivery work is shaped around usability, reliability, security, performance, and maintainability.' },
    ],
    ...
    company: 'Company',
    email: 'Work email',
    interest: 'Project focus',
    timeline: 'Timeline',
    interestOptions: ['Shopify Store Development', 'AI Consulting', 'Cloud Consulting', 'Platform Engineering', 'API and AI Gateway', 'llmxy', 'LetScrum', 'Other'],
    timelineOptions: ['This quarter', 'Next quarter', 'Exploring options', 'Urgent support'],
    messageLabel: 'What should we know?',
    messagePlaceholder: 'Briefly describe the storefront, product, platform, team, or architecture challenge.',
    consentPrefix: 'I agree to receive communications from Learnmark. You can unsubscribe at any time. Review our',
    privacyPolicy: 'Privacy Policy',
    consentSuffix: '.',
    submit: 'Send request',
    submitting: 'Submitting...',
    replyTime: 'We usually reply within 1 business day.',
