...
export const contactMessages: Record<Locale, ContactMessages> = {
  en: {
    ...
    interestOptions: ['A client consultation project', 'Joining the expert network', 'An institutional partnership', 'Compliance, privacy, or data processing', 'Pilot eligibility'],
