...
export const aboutMessages: Record<Locale, AboutMessages> = {
  en: {
    seoTitle: 'About Us',
    seoDescription: 'Learn how Learnmark helps corporate, consulting, and investment teams reach relevant experts through managed primary research engagements.',
    seoKeywords: ['Learnmark expert network', 'expert research company', 'primary research firm', 'expert consultation team'],
    eyebrow: 'About Learnmark',
    title: 'Expert research designed around the decision at hand.',
    description: 'Learnmark helps organizations reach relevant operating experience through focused, carefully managed expert consultations. We combine a maintained expert network, targeted outreach, and hands-on project support.',
    workCta: 'Work with us',
    aiCta: 'See how it works',
    operatingTitle: 'Operating model',
    operatingSubtitle: 'How we move from a question to a useful conversation',
    operatingModel: [
      { name: 'Understand', description: 'Clarify the decision, research gaps, target experience, timing, and constraints.' },
      { name: 'Qualify', description: 'Design screening questions, identify relevant experts, and evaluate fit and conflicts.' },
      { name: 'Support', description: 'Coordinate selection, terms, scheduling, consultation, and project follow-through.' },
    ],
    missionEyebrow: 'Our mission',
    missionTitle: 'Make hard-to-reach experience useful and accessible.',
    missionDescription: 'Important decisions often depend on context that cannot be found in published data. We create a responsible path to people who understand markets, functions, technologies, and operating realities firsthand.',
    capabilities: [
      { name: 'Human-led research', description: 'A dedicated project team translates broad questions into focused searches and useful screening criteria.' },
      { name: 'Relevant expertise', description: 'We maintain our network and add targeted outreach when a project requires new backgrounds.' },
      { name: 'Managed engagements', description: 'We coordinate qualification, terms, compliance, scheduling, consultation, and follow-up.' },
    ],
    principlesEyebrow: 'Working principles',
    principlesTitle: 'What guides every expert engagement',
    principlesDescription: 'Our process is designed to produce relevant primary insight while respecting the obligations and boundaries of every participant.',
    principles: [
      { name: 'Relevance before volume', description: 'We optimize for credible fit with the research question, not the number of profiles presented.' },
      { name: 'Human judgment', description: 'Technology supports the workflow, while people remain accountable for scoping, screening, and project decisions.' },
      { name: 'Clear boundaries', description: 'We do not seek confidential, proprietary, material non-public, or otherwise restricted information.' },
      { name: 'Active support', description: 'A Learnmark team stays involved from the initial brief through consultation completion.' },
    ],
