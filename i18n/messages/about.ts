...
export const aboutMessages: Record<Locale, AboutMessages> = {
  en: {
    seoTitle: 'About Us',
    seoDescription: 'Learn about Learnmark, an AI and Cloud consulting company helping teams build intelligent products and modern cloud platforms.',
    seoKeywords: ['Learnmark company', 'AI consulting company', 'cloud consulting company', 'technology consulting team'],
    eyebrow: 'About Learnmark',
    title: 'Practical AI and Cloud consulting for teams that need to ship.',
    description: 'Learnmark helps organizations navigate AI adoption and cloud modernization, turning complex technology decisions into secure, scalable, and maintainable software systems.',
    workCta: 'Work with us',
    aiCta: 'Explore AI consulting',
    operatingTitle: 'Operating model',
    operatingSubtitle: 'How we move from strategy to production',
    operatingModel: [
      { name: 'Assess', description: 'Clarify goals, constraints, architecture risks, and business context.' },
      { name: 'Design', description: 'Shape AI and cloud architecture into an implementation-ready roadmap.' },
      { name: 'Deliver', description: 'Build foundations, coach teams, and move production systems forward.' },
    ],
    missionEyebrow: 'Our mission',
    missionTitle: 'Make every application intelligent, reliable, and cloud-ready.',
    missionDescription: 'We combine senior engineering judgment with hands-on delivery support, helping teams make clear technical decisions and build durable systems.',
    capabilities: [
    ...
    principlesTitle: 'What guides our consulting work',
    principlesDescription: 'We focus on the decisions, platforms, and delivery habits that make AI and cloud systems useful after launch.',
    principles: [
