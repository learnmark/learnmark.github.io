...
export const homeMessages: Record<Locale, HomeMessages> = {
  en: {
    ...
    intro: {
      ...
      availabilityNotice: 'Project availability, contracting, jurisdiction, and service format are confirmed case by case. This public website is available in six languages; the initial authenticated workflow and AI-moderated interviews are designed for English and Chinese.',
      staticAvailabilityNotice: 'Project availability, contracting, jurisdiction, and service format are confirmed case by case. This static edition is English-only; the initial authenticated workflow and AI-moderated interviews are designed for English and Chinese.',
    ...
    workWith: {
      ...
      links: ['Discuss a project', 'View client controls', 'Explore every stage'],
      services: [
  ...
  'zh-CN': {
    ...
    intro: {
      ...
      availabilityNotice: '项目可用性、签约主体、司法辖区和服务形式须逐案确认。当前公开网站提供六种语言；首期登录平台流程和 AI 主持访谈按中文与英文设计。',
      staticAvailabilityNotice: '项目可用性、签约主体、司法辖区和服务形式须逐案确认。静态版本仅提供英文；首期登录平台流程和 AI 主持访谈按中文与英文设计。',
      modelTitle: '受控专家咨询流程',
  ...
  'zh-TW': {
    ...
    intro: {
      ...
      availabilityNotice: '專案可用性、簽約主體、司法管轄區與服務形式須逐案確認。目前公開網站提供六種語言；首期登入平台流程與 AI 主持訪談按中文及英文設計。',
      staticAvailabilityNotice: '專案可用性、簽約主體、司法管轄區與服務形式須逐案確認。靜態版本僅提供英文；首期登入平台流程與 AI 主持訪談按中文及英文設計。',
      modelTitle: '受控專家顧問流程',
  ...
  ja: {
    ...
    intro: {
      ...
      availabilityNotice: '案件の提供可否、契約主体、管轄、提供形式は個別に確認します。公開ウェブサイトは 6 言語に対応していますが、初期の認証済みワークフローと AI インタビューは英語・中国語向けに設計されています。',
      staticAvailabilityNotice: '案件の提供可否、契約主体、管轄、提供形式は個別に確認します。静的版は英語のみで、初期の認証済みワークフローと AI インタビューは英語・中国語向けに設計されています。',
    ...
    workWith: {
      ...
      links: ['案件を相談', 'クライアント統制を見る', '全段階を見る'],
      services: [
  ...
  fr: {
    ...
    intro: {
      ...
      availabilityNotice: 'La disponibilité, l’entité contractante, la juridiction et le format sont confirmés au cas par cas. Le site public existe en six langues ; le premier parcours authentifié et les entretiens IA sont conçus pour l’anglais et le chinois.',
      staticAvailabilityNotice: 'La disponibilité, l’entité contractante, la juridiction et le format sont confirmés au cas par cas. L’édition statique est uniquement en anglais ; le premier parcours authentifié et les entretiens IA sont conçus pour l’anglais et le chinois.',
    ...
    workWith: {
      ...
      links: ['Discuter d’un projet', 'Voir les contrôles client', 'Explorer toutes les étapes'],
      services: [
  ...
  de: {
    ...
    intro: {
      ...
      availabilityNotice: 'Verfügbarkeit, Vertragspartner, Rechtsraum und Leistungsformat werden je Projekt bestätigt. Die öffentliche Website ist sechssprachig; der erste geschützte Ablauf und KI-Interviews sind für Englisch und Chinesisch ausgelegt.',
      staticAvailabilityNotice: 'Verfügbarkeit, Vertragspartner, Rechtsraum und Leistungsformat werden je Projekt bestätigt. Die statische Ausgabe ist nur englisch; der erste geschützte Ablauf und KI-Interviews sind für Englisch und Chinesisch ausgelegt.',
    ...
    workWith: {
      ...
      links: ['Projekt besprechen', 'Kundenkontrollen ansehen', 'Alle Phasen erkunden'],
      services: [
