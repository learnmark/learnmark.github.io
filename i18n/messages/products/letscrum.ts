...
export const letscrumProductMessages: Record<Locale, LetScrumProductMessages> = {
  en: {
    ...
    screenshotsDescription: 'These screenshots show the LetScrum flow from organization and project setup through sprint planning, taskboard execution, backlog tracking, and burndown reporting.',
    screenshots: [
      { alt: 'LetScrum organization directory', title: 'Organization management', description: 'Browse organizations, compare member counts, switch workspaces, and create a new organization from one directory.' },
      { alt: 'LetScrum project directory', title: 'Project management', description: 'Review projects within an organization with descriptions, member counts, filters, and quick creation controls.' },
      { alt: 'LetScrum project sprint overview', title: 'Project sprint overview', description: 'See past and current sprints, delivery dates, status, and direct entry points from the project overview.' },
      ...
      { alt: 'LetScrum sprint backlog', title: 'Structured sprint backlog', description: 'Manage parent work items and nested tasks with workflow state, assignees, ordering, and remaining effort in one table.' },
      { alt: 'LetScrum sprint burndown chart', title: 'Sprint burndown', description: 'Compare actual and ideal remaining work by day, with total, completed, and remaining task counts.' },
    ],
  ...
  'zh-CN': {
    ...
    screenshotsDescription: '这些截图展示 LetScrum 从组织与项目设置，到冲刺规划、任务板执行、待办跟踪和燃尽报告的完整流程。',
    screenshots: [
      { alt: 'LetScrum 组织目录', title: '组织管理', description: '在统一目录中浏览组织、比较成员数量、切换工作空间并创建新组织。' },
      { alt: 'LetScrum 项目目录', title: '项目管理', description: '按组织查看项目说明和成员数量，并使用筛选及快速创建控件管理项目。' },
      { alt: 'LetScrum 项目冲刺概览', title: '项目冲刺概览', description: '查看过去与当前冲刺的交付日期、状态和直接入口，快速掌握项目节奏。' },
      { alt: 'LetScrum 冲刺任务板', title: '冲刺任务板', description: '在待办、进行中和已完成列间跟踪工作项，包括状态、负责人、估算、缺陷和清单项。' },
      { alt: 'LetScrum 冲刺待办列表', title: '结构化冲刺待办列表', description: '在同一表格中管理父工作项与嵌套任务的状态、负责人、顺序和剩余工作量。' },
      { alt: 'LetScrum 冲刺燃尽图', title: '冲刺燃尽图', description: '按天比较实际与理想剩余工作，并汇总任务总数、已完成数和剩余数。' },
    ],
  ...
  'zh-TW': {
    ...
    screenshotsDescription: '這些截圖呈現 LetScrum 從組織與專案設定，到衝刺規劃、任務板執行、待辦追蹤和燃盡報告的完整流程。',
    screenshots: [
      { alt: 'LetScrum 組織目錄', title: '組織管理', description: '在統一目錄中瀏覽組織、比較成員數量、切換工作空間並建立新組織。' },
      { alt: 'LetScrum 專案目錄', title: '專案管理', description: '依組織檢視專案說明和成員數量，並使用篩選及快速建立控制項管理專案。' },
      { alt: 'LetScrum 專案衝刺概覽', title: '專案衝刺概覽', description: '檢視過去與目前衝刺的交付日期、狀態和直接入口，快速掌握專案節奏。' },
      { alt: 'LetScrum 衝刺任務板', title: '衝刺任務板', description: '在待辦、進行中與已完成欄之間追蹤工作項目，包括狀態、負責人、估算、錯誤與清單項目。' },
      { alt: 'LetScrum 衝刺待辦清單', title: '結構化衝刺待辦清單', description: '在同一表格中管理父工作項目與巢狀任務的狀態、負責人、順序和剩餘工作量。' },
      { alt: 'LetScrum 衝刺燃盡圖', title: '衝刺燃盡圖', description: '依日期比較實際與理想剩餘工作，並彙總任務總數、已完成數和剩餘數。' },
    ],
  ...
  ja: {
    ...
    screenshotsDescription: '組織・プロジェクト設定からスプリント計画、タスクボード実行、バックログ追跡、バーンダウンレポートまでの LetScrum の流れを紹介します。',
    screenshots: [
      { alt: 'LetScrum 組織一覧', title: '組織管理', description: '組織の閲覧、メンバー数の比較、ワークスペースの切り替え、新しい組織の作成を一つの画面で行えます。' },
      { alt: 'LetScrum プロジェクト一覧', title: 'プロジェクト管理', description: '組織内のプロジェクトを説明やメンバー数とともに確認し、フィルターやクイック作成機能で管理します。' },
      { alt: 'LetScrum プロジェクトスプリント概要', title: 'プロジェクトスプリント概要', description: '過去と現在のスプリント、デリバリー日程、状態、各スプリントへの入口をプロジェクト概要で確認します。' },
      { alt: 'LetScrum スプリントタスクボード', title: 'スプリントタスクボード', description: '状態、担当者、見積り、バグ、チェック項目とともに To Do、In Progress、Done の列で作業を追跡します。' },
      { alt: 'LetScrum スプリントバックログ', title: '構造化スプリントバックログ', description: '親作業項目と入れ子のタスクについて、状態、担当者、順序、残作業を一つの表で管理します。' },
      { alt: 'LetScrum スプリントバーンダウンチャート', title: 'スプリントバーンダウン', description: '日ごとの実際と理想の残作業を比較し、タスクの総数、完了数、残数を確認します。' },
    ],
  ...
  fr: {
    ...
    screenshotsDescription: 'Ces captures illustrent le flux LetScrum, de la configuration des organisations et projets à la planification des sprints, au tableau de tâches, au suivi du backlog et au burndown.',
    screenshots: [
      { alt: 'Répertoire des organisations LetScrum', title: 'Gestion des organisations', description: 'Parcourez les organisations, comparez le nombre de membres, changez d’espace de travail et créez une organisation depuis un même répertoire.' },
      { alt: 'Répertoire des projets LetScrum', title: 'Gestion des projets', description: 'Consultez les projets d’une organisation avec leur description et leur nombre de membres, puis utilisez les filtres et la création rapide.' },
      { alt: 'Vue des sprints du projet LetScrum', title: 'Vue des sprints du projet', description: 'Consultez les sprints passés et actuels, leurs dates, leur état et leurs accès directs depuis la vue du projet.' },
      ...
      { alt: 'Backlog de sprint LetScrum', title: 'Backlog de sprint structuré', description: 'Gérez les éléments parents et tâches imbriquées avec leur état, responsable, ordre et effort restant dans un même tableau.' },
      { alt: 'Graphique burndown du sprint LetScrum', title: 'Burndown du sprint', description: 'Comparez chaque jour le travail restant réel et idéal, avec le nombre total de tâches, terminées et restantes.' },
    ],
  ...
  de: {
    ...
    screenshotsDescription: 'Die Screenshots zeigen den LetScrum-Ablauf von der Organisations- und Projekteinrichtung über Sprint-Planung und Taskboard-Umsetzung bis zu Backlog-Verfolgung und Burndown-Bericht.',
    screenshots: [
      { alt: 'LetScrum-Organisationsübersicht', title: 'Organisationsverwaltung', description: 'Organisationen durchsuchen, Mitgliederzahlen vergleichen, Arbeitsbereiche wechseln und neue Organisationen in einer Übersicht erstellen.' },
      { alt: 'LetScrum-Projektübersicht', title: 'Projektverwaltung', description: 'Projekte einer Organisation mit Beschreibungen und Mitgliederzahlen prüfen sowie Filter und Schnellerstellung verwenden.' },
      { alt: 'LetScrum-Projekt-Sprintübersicht', title: 'Projekt-Sprintübersicht', description: 'Vergangene und aktuelle Sprints, Delivery-Termine, Status und direkte Einstiege in der Projektübersicht anzeigen.' },
      ...
      { alt: 'LetScrum-Sprint-Backlog', title: 'Strukturiertes Sprint-Backlog', description: 'Übergeordnete Arbeitselemente und verschachtelte Aufgaben mit Status, Zuständigen, Reihenfolge und Restaufwand in einer Tabelle verwalten.' },
      { alt: 'LetScrum-Sprint-Burndown-Diagramm', title: 'Sprint-Burndown', description: 'Tatsächliche und ideale Restarbeit pro Tag sowie Gesamtzahl, abgeschlossene und verbleibende Aufgaben vergleichen.' },
    ],
